...
const Home = (props) => {
  const problemClick = () => problemRef.current?.scrollIntoView({
    behavior: 'smooth'
  });
  const problemRef = useRef();
  const loc = useLocation();
  // const state  = props?.location==undefined?null:props?.location;
  if(loc?.state?.goto){
    problemClick()
  }
  ...
  return (
    <>
    {/* <Problems/> */}
    <div id="problems" ref={problemRef}>
      <div class="the-problems">
        <div class="problems-section1">
            <div class="heading-highlights">
                <img id="highlight-heading" src={Sun} alt="Sun Photo"/><h1 id="heading-problems">Why this project <span className="created">is Created ? <img id="underline1" src ={underline1} alt = "underline"/></span></h1><img id="arrow1" src={Arrow1} alt="arrow"/>
                </div>          
            <div class="cards">
                <div class="card1">
